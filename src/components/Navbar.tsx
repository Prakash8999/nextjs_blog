      ...
      <div className='fixed top-0 inset-x-0 h-fit bg-zinc-200 border-b border-zinc-300 z-[10] py-2 '>
        <div className='h-full container w-full px-10  flex items-center justify-between gap-2'>
          ...
          <div className="relative w-[50vw]">
            ...
            {/* <input type="search" id="default-search" className="block w-full p-3 pl-10 text-sm text-gray-900 border border-gray-300 rounded-3xl bg-gray-50 focus:ring-blue-500 outline-none" placeholder="Search on redlone" required /> */}
            ...
            <ChangeablePlaceholderSearchBar/>
          </div>
